...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get(
    'DATABASE_URL', 
    'postgresql://localhost/gmc_calculations'
)
...
def service_info():
    ...
    return jsonify({
        ...
        "endpoints": [
            ...
            {"path": "/api/v1/projects/{project_id}/sessions", "method": "GET", "description": "List project sessions"},
            {"path": "/api/v1/projects/{project_id}/calculate", "method": "POST", "description": "Calculate GMC parameters"}
        ],
        "features": [
